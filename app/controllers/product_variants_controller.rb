class ProductVariantsController < ApplicationController
  ...
  def index
    @pages = ProductVariant.pages
    @product_variants = ProductVariant.page(current_page)
  end
  ...
  private
    ...
    def product_variant_params
      params.require(:product_variant).permit(:product_id, :size_id, :color_id, :stock, :price, :discount, :picture, :sku, :final_price)
    end
end
